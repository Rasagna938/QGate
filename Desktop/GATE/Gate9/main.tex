...
\begin{enumerate}
   ...
   \begin{table}[H]
        \centering
        \input{tables/Q3.tex}  % Use the correct path to your Q4.tex file
    \end{table}
    ...
    \begin{enumerate}
        \item \begin{figure}[H]
        \centering
        \input{figs/Q7A.tex}  % Use the correct path to your Q4.tex file
    \end{figure}
        \item \begin{figure}[H]
        \centering
        \input{figs/Q7B.tex}  % Use the correct path to your Q4.tex file
    \end{figure}
    \item \begin{figure}[H]
        \centering
        \input{figs/Q7C.tex}  % Use the correct path to your Q4.tex file
    \end{figure}
    \item \begin{figure}[H]
        \centering
        \input{figs/Q7D.tex}  % Use the correct path to your Q4.tex file
    \end{figure}
    \end{enumerate}
...
\section*{Q6-Q10 carry two marks each.}
    ...
    \item The monthly distribution of 9 Watt LED bulbs sold by two firms X and Y from January to June 2018 is shown in the pie-chart and corresponding table. If the total number of LED bulbs sold during April-June 2018 is 50,000, then the number of LED bulbs sold by the firm Y during April-June 2018 is {\underline{\hspace{2cm}}}
     \begin{table}[H]
        \centering
        \input{tables/Q13.tex}  % Use the correct path to your Q4.tex file
    \end{table}
\begin{figure}[H]
        \centering
        \input{figs/Q13.tex}  % Use the correct path to your Q4.tex file
    \end{figure}
