...
\begin{tikzpicture}
    ...
    % Draw the top and bottom mirrors with north-east line hatching
    \fill[pattern=north east lines] (-3,3.1) rectangle (3,3); % Top mirror
